...
CREATE TABLE IF NOT EXISTS `dbVilleFutee`.`Personne_has_categorie` (
  ...
  CONSTRAINT `fk_Personne_has_categorie_categorie1`
    ...
    REFERENCES `dbVilleFutee`.`categorie` (`categorie_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `dbVilleFutee`.`Reseau_has_categorie` (
  `Reseau_idReseau` INT NOT NULL,
  `Reseau_Utilisateur_chef` VARCHAR(30) NOT NULL,
  `categorie_categorie_id` INT NOT NULL,
  PRIMARY KEY (`Reseau_idReseau`, `Reseau_Utilisateur_chef`, `categorie_categorie_id`),
  INDEX `fk_Reseau_has_categorie_categorie1_idx` (`categorie_categorie_id` ASC),
  INDEX `fk_Reseau_has_categorie_Reseau1_idx` (`Reseau_idReseau` ASC, `Reseau_Utilisateur_chef` ASC),
  CONSTRAINT `fk_Reseau_has_categorie_Reseau1`
    FOREIGN KEY (`Reseau_idReseau` , `Reseau_Utilisateur_chef`)
    REFERENCES `dbVilleFutee`.`Reseau` (`idReseau` , `Utilisateur_chef`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
